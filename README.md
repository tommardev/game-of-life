...
We're taking a classic computer science concept and adding a bit of "spice" to it. Most Game of Life clones are just sterile black-and-white grids. Boring. We're going to visualize _why_ these little bastards are living or dying.
...
- **The Autopsy Tooltips:** Hover over any doomed cell to see _exactly_ why it's about to perish in the next tick (too many neighbors? too few? just bad luck?).
